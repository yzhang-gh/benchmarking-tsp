...
INSTRUCTIONS FOR INSTALLATION: (Version 3.0.7 - November 2021)
-----------------------------

The software is available in gzipped tar format:

	LKH-3.0.7.tgz	(approximately 2.3 MB)
...
An executable file called LKH will now be available in the directory LKH-3.0.7.
